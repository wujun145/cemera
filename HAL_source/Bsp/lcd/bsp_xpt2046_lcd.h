...
****************/
#define             XPT2046_PENIRQ_GPIO_CLK                        RCC_AHB1Periph_GPIOG 
#define             XPT2046_PENIRQ_GPIO_PORT                       GPIOG
 #define             XPT2046_PENIRQ_GPIO_PIN                        GPIO_Pin_8
...
#define             XPT2046_SPI_GPIO_CLK                         RCC_AHB1Periph_GPIOD| RCC_AHB1Periph_GPIOG

#define             XPT2046_SPI_CS_PIN		                        GPIO_Pin_7
#define             XPT2046_SPI_CS_PORT		                        GPIOD

#define	            XPT2046_SPI_CLK_PIN	                          GPIO_Pin_9
#define             XPT2046_SPI_CLK_PORT	                        GPIOG

#define	            XPT2046_SPI_MOSI_PIN	                        GPIO_Pin_6
#define	            XPT2046_SPI_MOSI_PORT	                        GPIOD

#define	            XPT2046_SPI_MISO_PIN	                        GPIO_Pin_3
#define	            XPT2046_SPI_MISO_PORT	                        GPIOD
