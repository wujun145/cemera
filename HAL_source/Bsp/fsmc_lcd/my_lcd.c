...
{    
    ...
    uint16_t* image_ptr = 0;
	uint16_t i=0;
	LCD_SetWindows(sx, sy, sx+LCD_PIXEL_WIDTH-1, sy+UVC_TARGET_HEIGHT-1);
...
//	HAL_GPIO_Init(GPIOB, &GPIO_InitStructure);
	...
	readWriteTiming.AddressSetupTime = 0xf;	//0xf
	readWriteTiming.AddressHoldTime = 0x00;
	readWriteTiming.DataSetupTime = 60;	//60
	...
	writeTiming.AddressSetupTime = 0x9;	//0x9
	writeTiming.AddressHoldTime = 0x00;
	writeTiming.DataSetupTime = 8;	//8
